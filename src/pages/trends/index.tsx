...
export default function Home({
  ...
  const itemList = createItemListJsonLd({
    ...
    items: (blogs ?? []).map((blog) => ({
      ...
      imageAlt:
        blog.coverImageAlt ||
        `${getPostTitle(blog, locale)} - Style Factory uniform trend`,
    })),
  });
  ...
  return (
    <>
      ...
      />
        ...
        >
          {/* Spacing for this page only; mobile = below 640px. */}
          <PostList
            blogs={blogs ?? []}
            bucket={BlogBuckets.trends}
            paddingTop={{ mobile: "130px", desktop: "176px" }}
