...
import {createOrganizationJsonLd, createWebPageJsonLd, createWebsiteJsonLd} from "@/utils/seo";
...
function SiteHeader() {
    ...
    const desktopNavItems = [
        {label: "Home", href: "/"},
        {label: "Assortment", href: "/trends"},
        {label: "Partners", href: "/blog"},
    ];

    return (
        <>
            <Box as="header" className={styles.siteHeader}>
                <Text
                ...
                >
                    {desktopNavItems.map((item, index) => (
                        <ChakraLink
                            ...
                            className={`${styles.desktopNavLink} ${index === 0 ? styles.desktopNavLinkActive : ""}`}
                        >
                            {item.label}
                        </ChakraLink>
                    ))}
                    <ChakraLink href="#contact" className={styles.desktopNavCta}>
                        Get in touch
                    </ChakraLink>
                </HStack>
                <Box
...
function HeroSection() {
    return (
        <Box
            ...
            overflow="hidden"
        >
            <Box className={styles.heroPortrait} aria-hidden="true">
                <Box className={styles.portraitScan}/>
            </Box>
            ...
            <Grid
                ...
                templateColumns={{base: "1fr", md: "650px minmax(0, 1fr)"}}
            >
                <Reveal>
                    <VStack
                        className={styles.heroCopy}
                        align="start"
                        maxW={{base: "320px", md: "650px"}}
                        spacing={{base: "4", md: "7"}}
                    >
                        <Text
                            as="h1"
                            ...
                            color="white"
                            fontFamily={poppins.style.fontFamily}
                            fontSize={{base: "38px", sm: "48px", md: "64px", xl: "78px"}}
                            fontWeight="700"
                            letterSpacing={{base: "0.008em", md: "0.014em"}}
                            lineHeight={{base: "1.1", md: "1.1"}}
                            maxW={{base: "310px", md: "650px"}}
                        >
                            Uniform Collection for Modern Brands
                        </Text>
                        <Text
                            order={{base: 1, md: 2}}
                            mt="0"
                            color={{base: "rgba(255, 255, 255, 0.76)", md: "rgba(255, 255, 255, 0.72)"}}
                            fontFamily={open_sans.style.fontFamily}
                            fontSize={{base: "11px", md: "20px"}}
                            fontWeight={{base: "600", md: "300"}}
                            letterSpacing={{base: "0.008em", md: "0.018em"}}
                            lineHeight={{base: "1.35", md: "1.42"}}
                            maxW={{base: "360px", md: "640px"}}
                            textTransform="uppercase"
                        >
                            We create uniforms and workwear for hospitality and corporate teams
                        </Text>
                        <Text
                            order={{base: 3, md: 3}}
                            color={{base: "rgba(255, 255, 255, 0.62)", md: "rgba(255, 255, 255, 0.68)"}}
                            fontFamily={open_sans.style.fontFamily}
                            fontSize={{base: "12px", md: "18px"}}
                            lineHeight={{base: "1.65", md: "1.55"}}
                            maxW={{base: "410px", md: "560px"}}
                        >
                            From idea to delivery, every collection is designed around your
                            brand identity.
                        </Text>
                        <Button
                            as="a"
                            ...
                            _hover={{bg: "#2a2a2a"}}
                        >
                            <Box as="span">Book a consultation</Box>
                            <Box as="span" className={styles.heroCtaArrow} aria-hidden="true">
                                &rarr;
                            </Box>
                        </Button>
                    </VStack>
...
function WhatWeDoSection() {
    return (
        <Box
            ...
            overflow="hidden"
        >
            <Text className={styles.scriptBackdrop} fontFamily={allura.style.fontFamily}>
                uniforms
            </Text>
            ...
            <Box className={styles.whatHeading}>
                <Text
                    ...
                    fontFamily={open_sans.style.fontFamily}
                >
                    <Box as="span" className={styles.whatHeadingStrong}>WHAT</Box>{" "}
                    <Box as="span" className={styles.whatHeadingSoft}>WE DO</Box>
                </Text>
            </Box>
            ...
            <Grid
                ...
                zIndex="1"
                alignItems="start"
                templateColumns={{base: "1fr", lg: "minmax(300px, 1fr) minmax(580px, 660px) minmax(300px, 1fr)"}}
            >
                ...
                <VStack className={styles.whatContent} position="relative" spacing="0">
                    <Box className={styles.threadPath}/>
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            style={{width: "100%"}}
                        >
                            <VStack className={styles.serviceBlock} position="relative" spacing="0" textAlign="center">
                                <Box
            ...
            >
                <Reveal>
                    <HStack
                        ...
                        spacing="5"
                    >
                        <Box display={{base: "none", lg: "block"}} h="180px" w="1px" bg="rgba(0,0,0,0.24)"/>
                        <Text
                            fontFamily={poppins.style.fontFamily}
                ...
                >
                    <SimpleGrid className={styles.clientsGrid} columns={{base: 4, md: 6}} spacing={{base: "3", md: "4"}}>
                        {clients.map((client) => (
                            <motion.div
                                key={client.name}
                                variants={softScale}
            ...
            >
                <Reveal className={styles.contactTitleItem}>
                    <Box className={styles.contactTitle}>
                        <Text
                            ...
                            textTransform="uppercase"
                        >
                            <Box as="span" className={styles.contactTitleStrong}>Get</Box>{" "}
                            <Box as="span" className={styles.contactTitleLight}>in touch</Box>
                        </Text>
                    </Box>
                </Reveal>
                ...
                <Reveal delay={0.08} className={styles.contactDetailsItem}>
                    ...
                    >
                        ...
                        <Text className={styles.contactPhoneSecondary}>+385 99 169 7537</Text>
                ...
                <Reveal delay={0.12} className={styles.contactFormItem}>
                    ...
                    >
                        <Input name="name" placeholder="Name" bg="rgba(255,255,255,0.78)" border="0" borderRadius="6px" h="52px"/>
                        <Input name="phone" placeholder="Phone" bg="rgba(255,255,255,0.78)" border="0" borderRadius="6px" h="52px"/>
                        <Input name="email" type="email" placeholder="Email address*" bg="rgba(255,255,255,0.78)" border="0" borderRadius="6px" h="52px"/>
                        <Input name="company" placeholder="Company*" bg="rgba(255,255,255,0.78)" border="0" borderRadius="6px" h="52px"/>
                        <Textarea
                            name="message"
                            placeholder="Message*"
                        ...
                        >
                            ...
                            <Box as="span" className={styles.contactSendArrow} aria-hidden="true">
                                &rarr;
                            </Box>
                        </Button>
                    </Grid>
...
function JourneyCard({
    ...
    return (
        ...
        >
            <Box className={styles.journeyCard} position="relative" minH={{base: "188px", md: "520px"}} pl={{base: "0", md: "0"}}>
                <Text
    ...
    return (
        ...
        >
            ...
            >
                <Grid className={styles.journeyLeftColumn} gap={{base: "7", md: "8"}}>
                    <Reveal>
                        <Text
                            ...
                            textTransform="uppercase"
                        >
                            <Box as="span" className={styles.journeyTitleStrong}>The Uniform</Box>{" "}
                            <Box as="span" className={styles.journeyTitleLight}>Journey</Box>
                        </Text>
                    </Reveal>
                ...
                <Grid className={styles.journeyRightColumn} gap={{base: "7", md: "8"}}>
...
function Home() {
    ...
    const description = "Custom uniform design, development, and production for hospitality, hotel, restaurant, and corporate teams in Croatia and Europe.";
        ...
        <>
            ...
            <Box className={styles.pageFrame}>
                <Box
                    ...
                    style={{"--sf-script-font": allura.style.fontFamily} as CSSProperties}
                >
                    <SiteHeader/>
                    <Box as="main">
                        <HeroSection/>
